...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        btagPNetAK4B = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probb')+bDiscriminator('pfParticleNetAK4JetTags:probbb')+bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc')+bDiscriminator('pfParticleNetAK4JetTags:probuds')+bDiscriminator('pfParticleNetAK4JetTags:probg'))>0?(bDiscriminator('pfParticleNetAK4JetTags:probb')+bDiscriminator('pfParticleNetAK4JetTags:probbb'))/(bDiscriminator('pfParticleNetAK4JetTags:probb')+bDiscriminator('pfParticleNetAK4JetTags:probbb')+bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc')+bDiscriminator('pfParticleNetAK4JetTags:probuds')+bDiscriminator('pfParticleNetAK4JetTags:probg')):-1",float,doc="ParticleNetAK4 b+bb+lepb tag discriminator",precision=10),
        btagPNetAK4CvL = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc')+bDiscriminator('pfParticleNetAK4JetTags:probuds')+bDiscriminator('pfParticleNetAK4JetTags:probg'))>0?(bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc'))/(bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc')+bDiscriminator('pfParticleNetAK4JetTags:probuds')+bDiscriminator('pfParticleNetAK4JetTags:probg')):-1",float,doc="ParticleNetAK4 c vs uds+g tag discriminator",precision=10),                     
        btagPNetAK4CvB = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probb')+bDiscriminator('pfParticleNetAK4JetTags:probbb')+bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc'))>0?(bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc'))/(bDiscriminator('pfParticleNetAK4JetTags:probc')+bDiscriminator('pfParticleNetAK4JetTags:probcc')+bDiscriminator('pfParticleNetAK4JetTags:probb')+bDiscriminator('pfParticleNetAK4JetTags:probbb')):-1",float,doc="ParticleNetAK4 c vs b tag discriminator",precision=10),                            
